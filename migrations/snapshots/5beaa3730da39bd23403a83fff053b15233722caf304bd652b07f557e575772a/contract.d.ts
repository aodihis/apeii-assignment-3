...
export type StorageHash =
  StorageHashBase<'5beaa3730da39bd23403a83fff053b15233722caf304bd652b07f557e575772a'>;
export type ExecutionHash =
  ExecutionHashBase<'46716fc91bc1b2a39f20dd87e07d37c9a89e15b068274b0ab6192570c0e4cf86'>;
...
export namespace Models {
  export type public_AgentMemorySession = {
    id: CodecTypes['pg/text@1']['output'];
    scopeKey: CodecTypes['pg/text@1']['output'];
    sessionId: CodecTypes['pg/text@1']['output'];
    userId: CodecTypes['pg/text@1']['output'] | null;
    metadata: CodecTypes['pg/jsonb@1']['output'];
    compactionState: CodecTypes['pg/jsonb@1']['output'] | null;
    createdAt: TimestampString<3>;
    updatedAt: TimestampString<3>;
    errors: public_AgentMemoryError[];
    messages: public_AgentMemoryMessage[];
    readonly [RelationKeys]?: 'errors' | 'messages';
  };
  export type public_AgentMemoryMessage = {
    id: CodecTypes['pg/text@1']['output'];
    memorySessionId: CodecTypes['pg/text@1']['output'];
    runId: CodecTypes['pg/text@1']['output'];
    turn: CodecTypes['pg/int4@1']['output'];
    position: CodecTypes['pg/int4@1']['output'];
    role: CodecTypes['pg/text@1']['output'];
    message: CodecTypes['pg/jsonb@1']['output'];
    createdAt: TimestampString<3>;
    memorySession: public_AgentMemorySession;
    readonly [RelationKeys]?: 'memorySession';
  };
  export type public_AgentMemoryError = {
    id: CodecTypes['pg/text@1']['output'];
    memorySessionId: CodecTypes['pg/text@1']['output'];
    runId: CodecTypes['pg/text@1']['output'];
    error: CodecTypes['pg/jsonb@1']['output'];
...
export declare const models: {
  public: {
    AgentMemorySession: Models.public_AgentMemorySession;
    AgentMemoryMessage: Models.public_AgentMemoryMessage;
    AgentMemoryError: Models.public_AgentMemoryError;
    Notes: Models.public_Notes;
  };
};
...
> & {
  ...
  readonly roots: {
    ...
    readonly notes: { readonly namespace: 'public' & NamespaceId; readonly model: 'Notes' };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
